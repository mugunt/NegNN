...
if __name__=="__main__":
    ...
    s = {'clr':1e-4,
        ...
        'w2v_emb_file':'/Users/ffancellu/git/is13/w2v_models/we_lm_sh_data_new_50/VectorModel-we_lm_sh_data_50.data',
         ...
         'syn1':'/Users/ffancellu/git/is13/w2v_models/we_lm_sh_data_new_50/VectorModel-we_lm_sh_data_50.data.syn1.npy',
        'logf':args.f}
    ...
    word_emb = tf.Variable(0.2 * tf.random_uniform([syn0.shape[0],s['es']], minval=-1.0, maxval=1.0, dtype=tf.float32),name='w_emb',trainable=False)
