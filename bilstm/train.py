...
with tf.Graph().as_default():
    ...
    with sess.as_default():
        ...
        optimizer = tf.train.AdamOptimizer(FLAGS.learning_rate).minimize(bi_lstm.loss) # Adam Optimizer
        ...
        for e in xrange(FLAGS.num_epochs):
            ...
            for i in xrange(len(train_lex)):
                ...
                # run training
                _, accuracy = sess.run([optimizer,bi_lstm.accuracy],feed_dict = feed_dict)
