...
if __name__=="__main__":
    ...
    parser.add_argument('-f',help="Folder to retrieve the info about the best system")

    args = parser.parse_args()

    params = {'nhidden':200, # number of hidden units
        'seed':345,
    ...
    with tf.Session() as sess:
        ...
        gold_ys_test = []
        all_sents_acc_tst = []
        test_lex, test_tags, _, test_y, test_cue, test_scope = test_set[0]
