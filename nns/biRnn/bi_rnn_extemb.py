...
if __name__=="__main__":
    ...
    params = {'clr':1e-4,
        ...
        'nepochs':100,
        'w2v_emb_file':'/Users/ffancellu/git/is13/w2v_models/we_lm_sh_data_new_50/VectorModel-we_lm_sh_data_50.data',
        'syn0':'/Users/ffancellu/git/is13/w2v_models/we_lm_sh_data_new_50/VectorModel-we_lm_sh_data_50.data.syn0.npy',
        'logf':args.f}
    ...
    emb_model = Word2Vec.load(params['w2v_emb_file'])
    syn0 = pad_embeddings(numpy.load(params['syn0']),params['es'])
    ...
    _weights = {
        ...
        'w_emb' : tf.Variable(0.2 * tf.random_uniform([syn0.shape[0],params['es']], minval=-1.0, maxval=1.0, dtype=tf.float32),name='w_emb'),
    ...
    with tf.Session() as sess:
        sess.run(init)
        sess.run(_weights['w_emb'].assign(syn0))
        try:
            for e in xrange(params['nepochs']):
                ...
                for i in xrange(nsentences):
                    ...
                    _mask = [1 if t!=vocsize else 0 for t in X]
